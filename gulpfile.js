...
if (config.configuracion.assets.fancybox == 1) {
    assetsAPPCSS.push(nodepath + '@fancyapps/fancybox/dist/jquery.fancybox.min.css');
    assetsAPPJS.push(nodepath + '@fancyapps/fancybox/dist/jquery.fancybox.min.js');
}
...
/**
 * Optimiza imagenes
 * Las imagenes a optimizar deben estár en la carpeta ./assets/images y se guardan en ./images
 * Esta optimización no es automatica, se debe hacer manualmente con el comando gulp images
 */
